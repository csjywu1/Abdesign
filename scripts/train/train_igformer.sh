...
# master address and port to localhost:9902, the command is as follows:
#
# GPU="0,1,4" ADDR=localhost PORT=9902 bash train_igformer.sh
#
# Default value: GPU=-1 (use cpu only), ADDR=localhost, PORT=9902
...
########## start training ##########
cd $CODE_DIR
${PREFIX} train2.py --gpus ${GPU_ARR[*]} ${CONFIG}
